  ...
  static appThemeData(BuildContext context) => {
        ThemeState.light: ThemeData(
          ...
          colorScheme: ColorScheme(
            ...
            onPrimaryContainer: AppColorScheme.primaryVariantColorLight,
            onSecondaryContainer: AppColorScheme.secondaryVariantColorLight,
          ),
          ...
          inputDecorationTheme:
              AppInputDecorationTheme.inputDecorationThemeLight(),
        ...
        ThemeState.dark: ThemeData(
          ...
          //textfield
          inputDecorationTheme:
              AppInputDecorationTheme.inputDecorationThemeDark(),
