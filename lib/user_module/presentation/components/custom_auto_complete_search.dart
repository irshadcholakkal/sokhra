...
import 'custom_autocomplete_search_controller.dart';
...
class CustomAutoCompleteSearch extends StatefulWidget {
  ...
  @override
  CustomAutoCompleteSearchState createState() => CustomAutoCompleteSearchState();
}

class CustomAutoCompleteSearchState extends State<CustomAutoCompleteSearch> {
        ...
        ? ChangeNotifierProvider.value(
            ...
            child: RoundedFrame(
              ...
              child: Row(
                children: <Widget>[
                  SizedBox(width: 10),
                  Icon(Icons.search, color: AppColorScheme.primaryColor),
                  SizedBox(width: 10),
